...
surface_url = "https://goldsmr4.gesdisc.eosdis.nasa.gov/opendap/MERRA2/M2I1NXASM.5.12.4/2021/08/MERRA2_401.inst1_2d_asm_Nx.20210829.nc4"
UV_url = "https://goldsmr5.gesdisc.eosdis.nasa.gov/opendap/MERRA2/M2I3NPASM.5.12.4/2021/08/MERRA2_401.inst3_3d_asm_Np.20210828.nc4"
H_url = "https://goldsmr5.gesdisc.eosdis.nasa.gov/opendap/MERRA2/M2I6NPANA.5.12.4/2021/08/MERRA2_401.inst6_3d_ana_Np.20210827.nc4"
TCWV_url = "https://goldsmr4.gesdisc.eosdis.nasa.gov/opendap/MERRA2/M2T1NXINT.5.12.4/2021/08/MERRA2_401.tavg1_2d_int_Nx.20210830.nc4"
...
U = UVTRH_dataset["U"].interp(lev=[1000, 850, 500]).interp(lon=fourcastnet_lon, lat=fourcastnet_lat)
V = UVTRH_dataset["V"].interp(lev=[1000, 850, 500]).interp(lon=fourcastnet_lon, lat=fourcastnet_lat)

#  850 hPa, 500 hPa | T, RH
T = UVTRH_dataset["T"].interp(lev=[1000, 850]).interp(lon=fourcastnet_lon, lat=fourcastnet_lat)
RH = UVTRH_dataset["RH"].interp(lev=[1000, 850]).interp(lon=fourcastnet_lon, lat=fourcastnet_lat)

# 1000 hPa, 850 hPa, 500 hPa,  50 hPa | Z
H_dataset = get_dataset(H_url).isel(time=0)
H = H_dataset["H"].interp(lev=[1000, 850, 500]).interp(lon=fourcastnet_lon, lat=fourcastnet_lat)
